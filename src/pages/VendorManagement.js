...
import { FaPencilAlt } from 'react-icons/fa'; // Import the edit icon
import "./ProductManagement.css"; // Assuming you have the CSS file for styling
                ...
                <div className="card productcard" key={index}>
                  ...
                  <div className="card-body">
                    <div className="cardbtn d-flex justify-content-end mt-4">
                      <a href="#" className="btn btn-icon pencil-icon" data-bs-toggle="modal" data-bs-target="#exampleModal"><FaPencilAlt /></a>
                    </div>
                  </div>
                </div>
              ))}
                    ...
                    <div className="col-lg-6">
                      ...
                      <form>
                        ...
                        <div className="d-flex justify-content-between flex-wrap mb-3">
                          {["Pillar 1", "Pillar 2", "Pillar 3", "Pillar 4", "Pillar 5", "Pillar 6"].map((pillar, index) => (
